...
/** Näringsvärden per 100 g (typiska svenska/handelsvärden). Speglar recept/app.js. Specifika före generiska. */
const PER_100G: Array<{ re: RegExp; m: MacroTotals }> = [
  /* —— Kyckling (färs/vingar/lår före bröst/filé, generic sist) —— */
  { re: /kycklingfärs|malet kyckling|ground chicken/i, m: { kcal: 115, prot: 21, carb: 0, fat: 5 } },
  { re: /kycklingving|chicken\s*wing|\bwings?\b/i, m: { kcal: 200, prot: 18, carb: 0, fat: 14 } },
  { re: /kycklinglår|lårfilé|benfria?\s*lår|kycklingben|drumstick|chicken\s*thigh|\bthighs?\b/i, m: { kcal: 140, prot: 20, carb: 0, fat: 7 } },
  { re: /kycklingbröst|kycklingfilé|chicken\s*breast/i, m: { kcal: 110, prot: 23, carb: 0, fat: 1.5 } },
  { re: /hel\s*kyckling|whole\s*chicken/i, m: { kcal: 170, prot: 19, carb: 0, fat: 10 } },
  { re: /kyckling|chicken/i, m: { kcal: 120, prot: 22, carb: 0, fat: 3 } },
  /* —— Övrigt kött (bacon före generisk fläsk) —— */
  { re: /bacon/i, m: { kcal: 400, prot: 25, carb: 1, fat: 35 } },
  { re: /nötfärs|malet nötkött|extra mager nöt|ground\s*beef/i, m: { kcal: 150, prot: 20, carb: 0, fat: 8 } },
  { re: /biff|entrecôte|ryggbiff|oxfilé|nötkött|beef/i, m: { kcal: 180, prot: 26, carb: 0, fat: 8 } },
  { re: /fläskfärs|malet fläsk|ground\s*pork/i, m: { kcal: 200, prot: 17, carb: 0, fat: 15 } },
  { re: /fläsk|karré|kotlett|pork/i, m: { kcal: 200, prot: 17, carb: 0, fat: 15 } },
  { re: /kalkon|turkey/i, m: { kcal: 110, prot: 24, carb: 0, fat: 1.5 } },
  { re: /lammfärs|lamm|lamb/i, m: { kcal: 220, prot: 18, carb: 0, fat: 16 } },
  /* —— Fisk & skaldjur —— */
  { re: /räk|shrimp|prawn/i, m: { kcal: 85, prot: 18, carb: 1, fat: 1 } },
  { re: /lax|salmon/i, m: { kcal: 190, prot: 20, carb: 0, fat: 12 } },
  { re: /torsk|sej|kolja|hoki|vitfisk|cod|white\s*fish/i, m: { kcal: 80, prot: 18, carb: 0, fat: 1 } },
  { re: /tonfisk|tuna/i, m: { kcal: 130, prot: 25, carb: 0, fat: 3 } },
  { re: /ansjovis|anchovy/i, m: { kcal: 200, prot: 25, carb: 0, fat: 10 } },
  { re: /mussla|blåmussla|scallop|kamussla|mussel/i, m: { kcal: 85, prot: 12, carb: 4, fat: 2 } },
  /* —— Ägg & växtprotein —— */
  { re: /äggvita|egg\s*white/i, m: { kcal: 50, prot: 11, carb: 1, fat: 0 } },
  { re: /äggula|egg\s*yolk/i, m: { kcal: 320, prot: 16, carb: 1, fat: 27 } },
  { re: /\bägg\b|\beggs?\b/i, m: { kcal: 140, prot: 12, carb: 1, fat: 10 } },
  { re: /tofu/i, m: { kcal: 120, prot: 12, carb: 2, fat: 7 } },
  { re: /tempeh/i, m: { kcal: 190, prot: 19, carb: 9, fat: 11 } },
  { re: /edamame/i, m: { kcal: 120, prot: 12, carb: 9, fat: 5 } },
  { re: /kikärt|chickpea/i, m: { kcal: 160, prot: 9, carb: 27, fat: 3 } },
  { re: /linser|lentil/i, m: { kcal: 115, prot: 9, carb: 20, fat: 0.5 } },
  { re: /svarta?\s*bönor|kidney|böna|beans?/i, m: { kcal: 120, prot: 8, carb: 20, fat: 0.5 } },
  /* —— Mejeri (fetthalt före generisk) —— */
  ...
  { re: /keso\s*4|keso|cottage/i, m: { kcal: 98, prot: 11, carb: 3, fat: 4 } },
  { re: /grekisk\s*yoghurt\s*0|nonfat\s*greek|0%\s*greek/i, m: { kcal: 55, prot: 10, carb: 4, fat: 0.2 } },
  { re: /grekisk\s*yoghurt|naturell\s*yoghurt|greek\s*yoghurt|greek\s*yogurt/i, m: { kcal: 70, prot: 7, carb: 4, fat: 3 } },
  { re: /yoghurt|yogurt/i, m: { kcal: 60, prot: 5, carb: 6, fat: 2 } },
  { re: /vispgrädde|grädde|cream(?!\s*cheese)|whipping/i, m: { kcal: 350, prot: 2, carb: 3, fat: 36 } },
  { re: /gräddfil|sour\s*cream/i, m: { kcal: 180, prot: 3, carb: 4, fat: 18 } },
  { re: /cr[eè]me\s*fra[iî]che|creme\s*fraiche/i, m: { kcal: 240, prot: 2.5, carb: 3, fat: 25 } },
  { re: /labneh/i, m: { kcal: 150, prot: 8, carb: 4, fat: 10 } },
  { re: /helmjölk|whole\s*milk/i, m: { kcal: 60, prot: 3.4, carb: 5, fat: 3.5 } },
  { re: /mellanmjölk/i, m: { kcal: 45, prot: 3.5, carb: 5, fat: 1.5 } },
  { re: /lättmjölk|skim\s*milk/i, m: { kcal: 35, prot: 3.5, carb: 5, fat: 0.5 } },
  { re: /havremjölk|mandelmjölk|sojamjölk|oat\s*milk|almond\s*milk/i, m: { kcal: 45, prot: 1, carb: 7, fat: 1.5 } },
  { re: /\bmjölk\b|milk/i, m: { kcal: 45, prot: 3.5, carb: 5, fat: 1.5 } },
  { re: /pecorino|parmesan/i, m: { kcal: 400, prot: 32, carb: 0, fat: 30 } },
  { re: /mozzarella|cheddar|cotija|swiss|leerdamer|feta|halloumi|ost\b|cheese/i, m: { kcal: 350, prot: 25, carb: 2, fat: 27 } },
  /* —— Kolhydrater —— */
  { re: /vetemjöl|self[- ]?rising|självjäsande|mjöl(?!k)/i, m: { kcal: 350, prot: 10, carb: 73, fat: 1 } },
  { re: /havremjöl|havregryn|havre|oat/i, m: { kcal: 370, prot: 13, carb: 60, fat: 7 } },
  { re: /kokt\s+.*\bris\b|\bris\b.*kokt|cooked\s+rice/i, m: { kcal: 130, prot: 2.5, carb: 28, fat: 0.3 } },
  { re: /\bris\b|jasminris|råris|basmati|klibbigt\s*ris/i, m: { kcal: 350, prot: 7, carb: 78, fat: 1 } },
  { re: /kokt\s+.*pasta|pasta.*kokt|cooked\s+pasta/i, m: { kcal: 140, prot: 5, carb: 28, fat: 1 } },
  { re: /spaghetti|pasta|nudlar|noodles|linguine|fettuccine|udon/i, m: { kcal: 350, prot: 12, carb: 70, fat: 1.5 } },
  { re: /gnocchi/i, m: { kcal: 160, prot: 4, carb: 33, fat: 0.5 } },
  { re: /kokt\s+.*potatis|potatis.*kokt|cooked\s+potato/i, m: { kcal: 85, prot: 2, carb: 18, fat: 0.1 } },
  { re: /potatis|potato/i, m: { kcal: 80, prot: 2, carb: 17, fat: 0.1 } },
  { re: /sötpotatis|sweet\s*potato/i, m: { kcal: 90, prot: 1.5, carb: 20, fat: 0.1 } },
  ...
  { re: /panko|ströbröd|brödsmul/i, m: { kcal: 380, prot: 12, carb: 72, fat: 3 } },
  { re: /brioche|hamburgerbröd|hoagie|bulle|bröd|wrap|tunnbröd|tortilla/i, m: { kcal: 280, prot: 9, carb: 50, fat: 5 } },
  { re: /majsstärkelse|potato\s*starch|corn\s*starch|stärkelse/i, m: { kcal: 350, prot: 0, carb: 85, fat: 0 } },
  ...
  { re: /jordnötssmör|peanut\s*butter|nötbutter|mandelsmör/i, m: { kcal: 600, prot: 25, carb: 15, fat: 50 } },
  { re: /pb2|jordnöts?pulver/i, m: { kcal: 375, prot: 40, carb: 30, fat: 10 } },
  { re: /nötter|jordnöt|cashew|mandel|valnöt|pecan|peanut/i, m: { kcal: 600, prot: 20, carb: 15, fat: 50 } },
  /* —— Såser & kryddor —— */
  { re: /soja|soy\s*sauce|thaisoja|tamari|coconut\s*aminos/i, m: { kcal: 55, prot: 8, carb: 5, fat: 0 } },
  ...
  { re: /lätt\s*majonnäs|light\s*mayo/i, m: { kcal: 300, prot: 1, carb: 8, fat: 28 } },
  ...
  { re: /socker|farinsocker|strösocker/i, m: { kcal: 400, prot: 0, carb: 100, fat: 0 } },
  { re: /risvinäger|vinäger|ättika|balsamico|ättik/i, m: { kcal: 20, prot: 0, carb: 1, fat: 0 } },
  ...
  { re: /pizzasås|tomatsås|passata/i, m: { kcal: 30, prot: 1, carb: 6, fat: 0 } },
  { re: /bbq|barbecuesås/i, m: { kcal: 150, prot: 1, carb: 35, fat: 0.5 } },
  { re: /senap|mustard/i, m: { kcal: 70, prot: 4, carb: 5, fat: 4 } },
  /* —— Grönsaker & arom —— */
  ...
  { re: /lök|rödlök|gul\s*lök|onion/i, m: { kcal: 40, prot: 1, carb: 9, fat: 0 } },
  { re: /gurka|cucumber/i, m: { kcal: 15, prot: 1, carb: 3, fat: 0 } },
  { re: /avokado|avocado/i, m: { kcal: 160, prot: 2, carb: 9, fat: 15 } },
  { re: /morot|carrot/i, m: { kcal: 40, prot: 1, carb: 9, fat: 0 } },
  { re: /tomat|tomato/i, m: { kcal: 18, prot: 1, carb: 4, fat: 0 } },
  { re: /jalapeño|chili(?!\s*(sauce|sås|crisp|crunch|olja|oil|flakes|flingor|pulver|flakes))/i, m: { kcal: 40, prot: 2, carb: 9, fat: 0 } },
  { re: /paprika(?!pulver)/i, m: { kcal: 30, prot: 1, carb: 6, fat: 0 } },
  { re: /grönkål|kale/i, m: { kcal: 50, prot: 3, carb: 9, fat: 1 } },
  { re: /spenat|spinach/i, m: { kcal: 25, prot: 3, carb: 2, fat: 0.5 } },
  { re: /ruccola|sallad|lettuce|blad/i, m: { kcal: 15, prot: 1, carb: 2, fat: 0 } },
  { re: /selleri|celery/i, m: { kcal: 15, prot: 1, carb: 3, fat: 0 } },
  { re: /zucchini|squash|aubergine|eggplant|broccoli|blomkål/i, m: { kcal: 25, prot: 2, carb: 4, fat: 0.3 } },
  { re: /basilika|koriander|mynta|persilja|dill|ört/i, m: { kcal: 40, prot: 3, carb: 6, fat: 0.5 } },
  { re: /pickles?\b|gurkinläggning/i, m: { kcal: 15, prot: 1, carb: 3, fat: 0 } },
  { re: /banan/i, m: { kcal: 90, prot: 1, carb: 23, fat: 0 } },
  { re: /äpple|apple|bär|berry|blåbär|jordgubb|hallon/i, m: { kcal: 55, prot: 0.5, carb: 12, fat: 0.2 } },
  /* —— Bak & dryck —— */
  { re: /proteinpulver|whey|kasein|casein|protein\s*powder/i, m: { kcal: 380, prot: 80, carb: 5, fat: 3 } },
  { re: /kakao|cocoa/i, m: { kcal: 230, prot: 20, carb: 10, fat: 14 } },
  ...
  { re: /vaniljextrakt|vanilla/i, m: { kcal: 50, prot: 0, carb: 12, fat: 0 } },
  { re: /sötningsmedel|stevia|monk\s*fruit|sukrin|lakanto/i, m: { kcal: 0, prot: 0, carb: 0, fat: 0 } },
  ...
  { re: /salt|peppar|pepper|\bmsg\b|krydda|paprikapulver|rökt\s*paprika|kummin|cayenne|oregano|kanel|gurkmeja|kardemumma|vitlökspulver|lökpulver|chilipulver|tajín|gochugaru|sichuan/i, m: { kcal: 0, prot: 0, carb: 0, fat: 0 } },
  { re: /vatten|water|buljong|stock|broth/i, m: { kcal: 5, prot: 0.5, carb: 0.5, fat: 0 } },
];
...
const PIECE_G: Array<{ re: RegExp; g: number }> = [
  ...
  { re: /tomat/i, g: 100 },
  { re: /jalapeño/i, g: 15 },
  { re: /rödlök|gul\s*lök|\blök\b/i, g: 80 },
  { re: /äggvita/i, g: 33 },
  { re: /ägg/i, g: 55 },
